...
<div class="top_box">
	...
	<div class="top_right">
		<ul>
			...
			<li><a href="{{url('admin/password_update')}}" target="main">修改密码</a></li>
			<li><a href="{{url('admin/destory_login')}}">退出</a></li>
		</ul>
	</div>
</div>
<!--头部 结束-->
...
<div class="bottom_box">
	CopyRight © 2015. Powered By <a href="http://www.huxao.con">http://www.huxao.cn</a>.
</div>
<!--底部 结束-->
@endsection
